...
```yaml
frontend:
  daily_drivers: [React, TypeScript, Tailwind CSS]
  also:          [Next.js]
...
```
 ...
 mass of spaghetti code deleted, mass of servers selfhosted,
 mass of tabs open in Firefox. Current quest: ship Lakartxela.
```
